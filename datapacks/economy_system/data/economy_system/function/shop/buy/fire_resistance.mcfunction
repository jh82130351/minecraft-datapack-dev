...
execute unless score @s coins matches 40.. run scoreboard players reset @s buy_fire_res
...
tellraw @s {"text":"✅ 화염 저항 포션 구매 완료!","color":"green"}
playsound minecraft:entity.experience_orb.pickup player @s ~ ~ ~ 1 1
scoreboard players reset @s buy_fire_res
